...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <form class="register-form justify-content-center col-sm-5" action="UPDATE_EQUIPMENT" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="equipmentID" name="txtEquipmentID" value="${requestScope.DTO.equipmentID}" readonly="true">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="txtPreviousImage" value="${requestScope.DTO.equipmentImage}"/>
                ...
                <button class="btn btn-primary btn-block mb-5" type="submit" name="action" value="UpdateEquipment">
                    Update
                </button>
            </form>
        </main>
