<%-- 
    Document   : fate_registration
    Created on : Jul 4, 2020, 9:51:47 AM
    Author     : ngota
--%>
...
<html>
    ...
    <body>
        ...
        <main>
            <h2>Fate Registration</h2>
            <form class="register-form justify-content-center col-sm-5" action="REGISTER_FATE" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="fateID" name="txtFateID" value="${requestScope.DTO.fateID}" required="true">
                ...
                <input type="hidden" name="txtDestPage" value="FATE_REGISTRATION_PAGE"/>
                <button class="btn btn-primary btn-block mb-5" type="submit" name="action" value="RegisterFate">
                    Register
                </button>
            </form>
        </main>
