...
<html>
    ...
    <body>
        ...
        <main>
            <h2>Update user</h2>
            <form class="register-form justify-content-center col-sm-5" action="UPDATE_USER" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="username">Username</label>
                    <input type="text" class="form-control" id="username" name="txtUserID" value="${requestScope.DTO.userID}" readonly="true">
                </div>
                <div class="form-group">
                    <label class="mr-2" for="role">Role</label><br />
                    <select class="form-control w-100" id="role" name="cbRoles">
                        <option value="Actor" 
                                <c:if test="${requestScope.DTO.roleID eq 'ACT'}">
                                    selected
                                </c:if>>Actor</option>
                        <option value="Director" 
                                <c:if test="${requestScope.DTO.roleID eq 'DIR'}">
                                    selected
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="fullname" name="txtFullname" value="${requestScope.DTO.fullname}" required="true" required="true">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="txtPreviousUserImage" value="${requestScope.DTO.userImage}">
                ...
                <button class="btn btn-primary btn-block mb-5" type="submit" name="action" value="UpdateUser">
                    Update
                </button>
            </form>
        </main>
