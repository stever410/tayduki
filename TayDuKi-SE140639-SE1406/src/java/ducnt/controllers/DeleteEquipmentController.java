    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (beans.deleteEquipment()) {
                url = properties.getProperties("SEARCH_EQUIPMENT");
                request.setAttribute("DELETE_SUCCESS", "Delete equipment success");
            }
        } catch (Exception e) {
            request.setAttribute("ERROR", "Can't delete this equipment");
