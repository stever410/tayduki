 ...
 * @author ngota
 */
public class EditFateActorCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = properties.getProperties("FATE_ACTOR_EDIT_PAGE");
        try {
            ...
            request.setAttribute("DTO", cart.getRoleNameFromCart(roleName));
        } catch (Exception e) {
            log("ERROR at EditFateActorCartController " + e.getMessage());
        } finally {
