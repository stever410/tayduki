 ...
 * @author ngota
 */
public class LoadFateHistoryOfActorController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = properties.getProperties("ACTOR_FATE_HISTORY_PAGE");
        try {
            ...
            beans.getHistoryFatesOfActor(recordToIgnored, resultToScreen);
            int totalPageCount = (int) Math.ceil((double) beans.getAmountHistoryFatesOfActor() / resultToScreen);
            request.setAttribute("REPORT_PAGE_COUNT", totalPageCount);
            request.setAttribute("CURRENT_PAGE", currentPage);
            request.setAttribute("REPORT", beans.getListReports());
        } catch (Exception e) {
            log("ERROR at LoadFateHistoryOfActorController " + e.getMessage());
        } finally {
