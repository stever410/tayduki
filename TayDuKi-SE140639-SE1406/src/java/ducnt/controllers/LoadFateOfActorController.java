 ...
 * @author ngota
 */
public class LoadFateOfActorController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = properties.getProperties("DOWNLOAD_FATE_PAGE");
        try {
            ...
            beans.getFatesFileByActorID();
            request.setAttribute("REPORT", beans.getListReports());
        } catch (Exception e) {
            log("ERROR at LoadFateOfActorController " + e.getMessage());
        } finally {
