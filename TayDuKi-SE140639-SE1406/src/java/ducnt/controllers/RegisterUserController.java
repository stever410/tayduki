...
public class RegisterUserController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = properties.getProperties("USER_REGISTRATION_PAGE");
        ...
        try {
            ...
            if (isMultiPart) {
                ...
                if (id.isEmpty() || id.length() > 100) {
                    valid = false;
                    errorObj.setUserIDError("Username length must be between 1 - 100");
                }
                ...
                //2.
                dto = new UserDTO(id, role, fullname, sex, phoneNum, email, description, DEFAULT_ICON);
                if (valid) {
...
//            e.printStackTrace();
            if (e.getMessage().contains("Violation of PRIMARY KEY constraint")) {
                errorObj.setUserIDError("Username has already exist");
            }
